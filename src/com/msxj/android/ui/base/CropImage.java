...
import com.msxj.android.activity.ImageFilterCropActivity;
	...
	class BackgroundJob implements Runnable {
		...
		public void run() {
				...
				public void run() {
					try {
						mHandler.sendMessage(mHandler
								.obtainMessage(ImageFilterCropActivity.SHOW_PROGRESS));
			...
			try {
				...
				mHandler.sendMessage(mHandler
						.obtainMessage(ImageFilterCropActivity.REMOVE_PROGRESS));
				// mHandler.post(new Runnable()
				// {
				// public void run()
				// {
