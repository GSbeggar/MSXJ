...
import com.msxj.android.menu.Desktop;
import com.msxj.android.menu.Friends;

import com.msxj.android.menu.Home;
import com.msxj.android.menu.Lbs;
import com.msxj.android.menu.Message;
import com.msxj.android.menu.Photo;
import com.msxj.android.menu.Recommend;
import com.msxj.android.menu.User;
import com.msxj.android.menu.Viewed;
import com.msxj.android.menu.Desktop.onChangeViewListener;
import com.msxj.android.ui.base.FlipperLayout;
import com.msxj.android.ui.base.FlipperLayout.OnOpenListener;
import com.msxj.android.ui.base.FlipperLayout.onUgcDismissListener;
import com.msxj.android.ui.base.FlipperLayout.onUgcShowListener;
import com.msxj.android.utils.ActivityForResultUtil;
import com.msxj.android.utils.PhotoUtil;
import com.msxj.android.utils.ViewUtil;

public class MainActivity extends MSXJActivity implements OnOpenListener {
	/**
	...
	private void setListener() {
		...
		mDesktop.setOnChangeViewListener(new onChangeViewListener() {
			...
			public void onChangeView(int arg0) {
				...
				case ViewUtil.PHOTO:
					if (mPhoto == null) {
						mPhoto = new Photo(MainActivity.this, mKXApplication,mScreenWidth,mInstance);
