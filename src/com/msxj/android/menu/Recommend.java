...
import com.msxj.android.activity.CreatActivity;
...
public class Recommend {
	...
	public Recommend(Context context, MSXJApplication application) {
		mContext = context;
	...
	private void findViewById() {
		mMenu = (ImageView) mRecommend.findViewById(R.id.recommend_menu);
		...
		mAdd = (Button) mRecommend.findViewById(R.id.recommend_add);
	}
	...
	private void setListener() {
		...
		mAdd.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// 暂时不做任何操作
				mContext.startActivity(new Intent(mContext, CreatActivity.class));
