...
public class Viewed {
	...
	public Viewed(Context context, MSXJApplication application) {
		mContext = context;
	...
	private void findViewById() {
		mMenu = (ImageView) mViewed.findViewById(R.id.viewed_menu);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (mIsFriends) {
				holder.image.setImageBitmap(mKXApplication.getViewed(result
						.getImage()));
				holder.owners.setText(result.getOwners_name() + "收藏");
			} else {
				holder.image.setImageBitmap(mKXApplication.getViewedHot(result
						.getImage()));
				holder.owners.setText(result.getForwarding_count() + "次收藏");
			}
			return convertView;
		}
