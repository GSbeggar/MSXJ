...
import com.msxj.android.ui.base.MyLetterListView;
import com.msxj.android.ui.base.FlipperLayout.OnOpenListener;
import com.msxj.android.ui.base.MyLetterListView.OnTouchingLetterChangedListener;
...
public class Friends {
	...
	public Friends(Context context, MSXJApplication application) {
		mContext = context;
	...
	private void setListener() {
		...
		mDisplay.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				FriendsResult result =  mMyFriendsResults.get(position);
