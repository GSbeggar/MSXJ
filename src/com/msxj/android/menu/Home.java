...
import com.msxj.android.activity.PhoneAlbumActivity;
import com.msxj.android.dodowaterfall.LazyScrollView;
import com.msxj.android.result.HomeResult;
...
public class Home {
	...
	private Button mnewest;
	private Button mhotso;
	...
	*/
	...
	private String[] mPopupWindowItems = { "热门动态", "最新动态","猜你喜欢","热搜美食" };
	...
	public Home(Context context, Activity activity, MSXJApplication application) {
		mContext = context;
		mActivity = activity;
	...
	private void findViewById() {
		mMenu = (ImageView) mHome.findViewById(R.id.home_menu);
		...
		mDisplay = (GridView) mHome.findViewById(R.id.home_display);
		mhot=(Button)mHome.findViewById(R.id.home_hot);
		mguess=(Button)mHome.findViewById(R.id.home_guess);
		mnewest=(Button)mHome.findViewById(R.id.home_newest);
		mhotso=(Button)mHome.findViewById(R.id.home_hotso);
	...
	private void setListener() {
		...
		mguess.setOnClickListener(new OnClickListener() {

			public void onClick(View v) {
				// 暂时不做任何操作
			}
		});mnewest.setOnClickListener(new OnClickListener() {

			public void onClick(View v) {
				// 暂时不做任何操作
			}
		});mhotso.setOnClickListener(new OnClickListener() {

			public void onClick(View v) {
				// 暂时不做任何操作mNearbyPeople
				mhotso.setBackgroundResource(R.drawable.bottomtabbutton_red);
		mhotso.setBackgroundResource(R.drawable.bottomtabbutton_rightwhite);
			}
		});
		// Path监听
	...
	private void initPopupWindow() {
		...
		if (mPopupWindow.isShowing()) {
			...
			mPopupWindow.showAsDropDown(mTopLayout, 0, -20);
		}
	}
	...
	private class HomeAdapter extends BaseAdapter {
		...
		//				.findViewById(R.id.home_photo_item_avatar);
			...
			//			.getAvatar(result.getAvatar()));
				...
				holder.viewed_all.setText("查看" + result.getName() + "的全部收藏");
			} else {
