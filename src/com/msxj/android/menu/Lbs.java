...
import com.msxj.android.activity.ShakeActivity;
import com.msxj.android.result.NearbyPeopleResult;
import com.msxj.android.result.NearbyPhotoDetailResult;
import com.msxj.android.result.NearbyPhotoResult;
import com.msxj.android.ui.base.MyListView;
import com.msxj.android.ui.base.NearbyPhotoLayout;
...
//	private TextView mNoDisplay;
	...
	public Lbs(Context context, MSXJApplication application) {
		mContext = context;
	...
	private void findViewById() {
		mMenu = (ImageView) mLbs.findViewById(R.id.lbs_menu);
		mGoLbs = (Button) mLbs.findViewById(R.id.lbs_golbs);
		mShake=(Button)mLbs.findViewById(R.id.shake);
...
//		mCheckIn = (Button) mLbs.findViewById(R.id.lbs_checkin);
	...
	private void setListener() {
		...
		mShake.setOnClickListener(new OnClickListener()
		{
