...
import com.msxj.android.activity.AboutActivity;
import com.msxj.android.activity.ChangeWallpagerActivity;
import com.msxj.android.activity.CheckInActivity;
import com.msxj.android.activity.ContactsActivity;
import com.msxj.android.activity.DiaryActivity;
import com.msxj.android.activity.EditSignatureActivity;
import com.msxj.android.activity.FriendInfoActivity;
import com.msxj.android.activity.FriendsActivity;
import com.msxj.android.activity.PhoneAlbumActivity;
import com.msxj.android.activity.PhotoActivity;
import com.msxj.android.activity.VisitorsActivity;
import com.msxj.android.activity.VoiceActivity;
import com.msxj.android.activity.WriteRecordActivity;
import com.msxj.android.anim.UgcAnimations;
import com.msxj.android.result.FriendInfoResult;
import com.msxj.android.result.StatusResult;
import com.msxj.android.result.VisitorsResult;
...
import com.msxj.android.utils.Utils;
...
public class User {
	...
	public User(Context context, Activity activity, MSXJApplication application) {
		mContext = context;
		mActivity = activity;
	...
	private void findViewById() {
		...
		*/
		...
		mMenu = (ImageView) mUser.findViewById(R.id.user_info_menu);
	...
	private void getInfo() {
		...
		try {
			...
			mHead_Photo.setText("菜谱 "
					+ mKXApplication.mMyInfoResult.getPhoto_count());
			mHead_Diary.setText("心情"
