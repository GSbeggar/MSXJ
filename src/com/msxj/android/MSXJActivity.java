 ...
 * 
 */
public class MSXJActivity extends Activity {
	protected MSXJApplication mKXApplication;
	/**
	 * 屏幕的宽度和高度
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mKXApplication = (MSXJApplication) getApplication();
		/**
		 * 获取屏幕宽度和高度
		 */
	...
	protected void showFace(View parent) {
		if (!mFacePop.isShowing()) {
			...
			.hideSoftInputFromWindow(MSXJActivity.this
